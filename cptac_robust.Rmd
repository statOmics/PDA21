...
Note that the samples upon robust summarisation show a clear separation in the second dimension of the MDS plot.
...
Note, that now 20 proteins are found to be differentially abundant!
