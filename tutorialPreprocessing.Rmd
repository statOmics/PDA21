...
The tutorial can be done using a script or using the graphical user interface that is provided by the `msqrob2gui` Shiny App. 
...
-  The MaxQuant data can be downloaded [zip file with data](https://github.com/statOmics/pda/archive/refs/heads/data.zip). The peptides.txt file can be found in data/quantification/cptacAvsB_lab3. 
...
[2.3.a] Participants can perform an analysis using the [GUI](./cptac_medianGui.html) or an [Rmarkdown script](./cptac_median.html)
