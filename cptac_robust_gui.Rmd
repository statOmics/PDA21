...
4. It is advicable to open the shiny app in a webbrowser. You can do that by clicking on the button `open in webbrowser`, which you can find above the blue navigation bar and the shinyApp will pop up in a new browser tab/window. 
