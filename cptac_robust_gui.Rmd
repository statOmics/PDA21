...
src="https://www.youtube.com/embed/ISF4g-Xbwec"
frameborder="0"
...
[2.3.5.a] We know the real FC for the spike in proteins (see description of the data 2.3). Note, that the boxplot is showing the log2 FC. What do you observe?

[2.3.5.b] Now select all yeast proteins. What is the real fold change and what do you observe?  

[2.3.5.c] Repeat this for the median summarization method. What do you observe, how does that compare to the robust summarisation and try to explain this?
...
- An R/markdown file for the analysis we performed above can be found below. if you click on the code button at the top right of the compiled html file of the analysis, a script with the code for the html file will be downloaded.
