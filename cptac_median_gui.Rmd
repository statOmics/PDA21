...
Note that only two proteins are displayed, because with median summarisation only two proteins can be picked up at the 5% FDR level. Fortunately both proteins are UPS proteins that were spiked-in. 
...
![Figure 10. MSqRob Fold Change Boxplot](./figures/msqrobRobSumFCAll.png)
...
![Figure 10. MSqRob Fold Change Boxplot](./figures/msqrobSumFCups.png)
